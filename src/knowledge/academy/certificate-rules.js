export const certificateRules = {
  ...
  requiredSkills: [
    { id: "salesforce-platform-foundations", name: "Salesforce Platform Foundations" },
    { id: "salesforce-object-modeling", name: "Salesforce Object Modeling" },
    { id: "salesforce-security-foundations", name: "Salesforce Security Foundations" },
    { id: "salesforce-app-user-experience", name: "Salesforce App User Experience" },
